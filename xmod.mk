...
$(call inherit-product, vendor/xmod/config/gsm.mk)

# Enhanced NFC
$(call inherit-product, vendor/xmod/config/nfc_enhanced.mk)

# Inherit some common CM stuff.
$(call inherit-product, vendor/xmod/config/common_full_phone.mk)

PRODUCT_NAME := xmod_bacon
