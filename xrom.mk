...
$(call inherit-product, vendor/xrom/config/gsm.mk)

# Enhanced NFC
$(call inherit-product, vendor/xrom/config/nfc_enhanced.mk)

# Inherit some common CM stuff.
$(call inherit-product, vendor/xrom/config/common_full_phone.mk)

PRODUCT_NAME := xrom_bacon
